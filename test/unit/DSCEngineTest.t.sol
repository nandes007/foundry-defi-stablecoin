...
contract DSCEngineTest is Test {
     ...
     */
    function testMustRedeemMoreThanZero() public depositCollateralAndMintedDsc {
        vm.startPrank(USER);
    ...
    function testHealthFactorCanGoBelowOne() public depositCollateralAndMintedDsc {
    ...
    function testCantLiquidateGoodHealthFactor() public depositCollateralAndMintedDsc {
        ERC20Mock(weth).mint(liquidator, collateralToCover);
     ...
     */
    function testGetCollateralTokePriceFeed() public view {
    ...
    function testLiquidationPrecision() public view {
        ...
        assertEq(expectedLiquidationPrecision, dsce.getLiquidationPrecision());
    }
}
