...
contract DSCEngine is ReentrancyGuard {
     ...
     * @param amountCollateral The amount collateral you're withdrawing
    ...
    /**
     * @notice follows CEI
     * @param amountDscToMint The amount of desentralize stablecoin to mint
